...
const Home = () => {
  return (
    <div className="h-screen w-full">
      <header className=" relative bg-[url('https://c4.wallpaperflare.com/wallpaper/24/23/796/portrait-display-vertical-pattern-digital-art-wallpaper-preview.jpg')] p-4 lg:bg-[url('https://png.pngtree.com/thumb_back/fh260/background/20200714/pngtree-modern-double-color-futuristic-neon-background-image_351866.jpg')] bg-cover h-screen w-full flex flex-col justify-center items-center ">
        ...
        <h1 className=" font-serif  md:hidden font-bold text-white text-sm lg:text-2xl">
