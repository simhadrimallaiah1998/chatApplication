      ...
      <div className="h-[100%]  w-full grid grid-cols-6 bg-yellow-950 lg:bg-[url('https://wallpapers.com/images/hd/vertical-night-sky-3c38e2irmokctrj1.jpg')] bg-cover">
        ...
        <div className="h-screen lg:hidden bg-blue-950 col-span-6">
          <div className="h-[20%]  bg-[url('https://png.pngtree.com/background/20210709/original/pngtree-shading-background-abstract-colorful-background-colorful-art-picture-image_938007.jpg')]  bg-cover">
            ...
            <button
              className="border-4  py-2 text-white bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAtdv5X5MEqVnjNLyFaXQOHnN8VE0V539Ydw&usqp=CAU')]  border-blue-950 w-full  font-extrabold rounded-3xl "
              onClick={handleDelete}
            >
